...
class Feature:
    ...
    def get_coordinate_for(self, sample: Sample):
        ...
        if value < self.min_value:
            print("Sample %s has value %s below the min value %s for feature %s", sample.id, value, self.min_value, self.feature_name)
        elif value > self.max_value:
            print("Sample %s has value %s above the max value %s for feature %s",  sample.id, value, self.max_value, self.feature_name)
